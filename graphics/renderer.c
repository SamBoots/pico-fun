...
{
    a_ctx->draw_8x16glyphs(a_ctx, a_str, a_len, a_spacing, a_scale, a_front_color, a_back_color, a_x, a_y);
    return 1;
}
...
{
    a_ctx->draw_4x8glyphs(a_ctx, a_str, a_len, a_spacing, a_scale, a_front_color, a_back_color, a_x, a_y);
    return 1;
}
