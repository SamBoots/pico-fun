...
{
    ssd1306_draw_8x16glyphs(a_ctx, a_str, a_len, a_spacing, a_scale, a_color, a_x, a_y);
    return 1;
}
...
{
    ssd1306_draw_4x8glyphs(a_ctx, a_str, a_len, a_spacing, a_scale, a_color, a_x, a_y);
    return 1;
}
...
int render_8x16glyphs_2x2border(render_context_t* a_ctx, const char* a_str, uint16_t a_len, uint16_t a_spacing, uint16_t a_scale, uint16_t a_color, uint16_t a_x, uint16_t a_y)
{
    ...
    ssd1306_draw_8x16glyphs(a_ctx, a_str, a_len, a_spacing, a_scale, a_color, a_x + padding, a_y + padding);
    // now draw border
...
int render_4x8glyphs_2x2border(render_context_t* a_ctx, const char* a_str, uint16_t a_len, uint16_t a_spacing, uint16_t a_scale, uint16_t a_color, uint16_t a_x, uint16_t a_y)
{
    ...
    ssd1306_draw_4x8glyphs(a_ctx, a_str, a_len, a_spacing, a_scale, a_color, a_x + padding, a_y + padding);
    // now draw border
